...
public class TesteStand {
  ...
  public static void main(String[] args) {
    ...
    v1 = new Veiculo("01-01-AA",200);
    v2 = new Veiculo("05-05-ZZ",150);
    v3 = new Veiculo("",390);
    v4 = new Veiculo ("", 890);
    v5 = new Veiculo ("", 9000);
    
    d1 = new Veiculos("55-GT-33",40);
    d2 = new Veiculos("55-GT-33",40);
    d3 = new Veiculos("55-GT-33",40);
    d4 = new Veiculos("55-GT-33",40);
    d5 = new Veiculos("55-GT-33",40);
